...
function autofixMergeConflicts(fileContent) {
    ...
    return (0, merge_lockfile_changes_1.mergeLockfileChanges)((0, lockfileFormatConverters_1.convertToLockfileObject)(js_yaml_1.default.load(ours)), (0, lockfileFormatConverters_1.convertToLockfileObject)(js_yaml_1.default.load(theirs)));
}
